"""Blindfold Square Vision speed-session model (60-second timed sessions).
...
class BlindfoldSquareVisionSpeedSession(Base):
    __tablename__ = "blindfold_square_vision_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="blindfold-square-vision", index=True)
