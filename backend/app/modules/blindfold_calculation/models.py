"""Blindfold Calculation speed-session model (60-second timed sessions).
...
class BlindfoldCalculationSpeedSession(Base):
    __tablename__ = "blindfold_calculation_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="blindfold-calculation", index=True)
