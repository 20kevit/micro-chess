"""Balance Scale speed-session model (60-second timed sessions).
...
class BalanceScaleSpeedSession(Base):
    __tablename__ = "balance_scale_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="balance-scale", index=True)
