"""Giving Check speed-session model (60-second timed sessions).
...
class GivingCheckSpeedSession(Base):
    __tablename__ = "giving_check_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="give-check", index=True)
