"""Get Out of Check speed-session model (60-second timed sessions).
...
class GetOutOfCheckSpeedSession(Base):
    __tablename__ = "get_out_of_check_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="get-out-of-check", index=True)
