"""Undefended Pieces speed-session model (60-second timed sessions).
...
class UndefendedSpeedSession(Base):
    __tablename__ = "undefended_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="undefended-pieces", index=True)
