"""Chinese Board speed-session model (60-second timed sessions).
...
class ChineseBoardSpeedSession(Base):
    __tablename__ = "chinese_board_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="chinese-board", index=True)
