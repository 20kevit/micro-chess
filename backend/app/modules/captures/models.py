"""Captures speed-session model (60-second timed sessions).
...
class CaptureSpeedSession(Base):
    __tablename__ = "capture_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="captures", index=True)
