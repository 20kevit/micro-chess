"""Captures routes: practice next-puzzle + speed sessions.
...
from app.modules.captures import schemas, sessions
from app.modules.captures.validator import SLUG
from app.modules.captures.sessions import (
    BufferNotReadyError,
...
def _to_out(session: sessions.CaptureSpeedSession) -> schemas.SessionOut:
    data = sessions.summary(session)
    return schemas.SessionOut(**data)


def _to_summary(session: sessions.CaptureSpeedSession) -> schemas.SessionSummary:
