...
PUZZLES: list[dict] = [
    ...
    {
        "fen": "4k3/7p/8/3p4/4K3/8/8/8 w - - 0 1",
        "from": "e4",
        "prompt_fa": "مهره‌هایی که شاه در e4 می‌تواند بزند را انتخاب کن.",
        "explanation": "سرباز d5 هیچ مدافعی ندارد، پس شاه می‌تواند آن را بزند.",
        "hints": [{"id": "h1", "text_fa": "ببین مقصد زیر ضربه دشمن هست یا نه.", "rating_cost": 10}],
        "rating": 1000.0,
    },
    {
        "fen": "4k3/8/2p5/3p4/4K3/8/8/8 w - - 0 1",
        "from": "e4",
        "prompt_fa": "مهره‌هایی که شاه در e4 می‌تواند بزند را انتخاب کن.",
        "explanation": "سرباز d5 را سرباز c6 دفاع می‌کند؛ شاه حق ندارد به خانه زیر ضربه برود.",
        "hints": [{"id": "h1", "text_fa": "مهره‌ای که دفاع می‌شود را شاه نمی‌تواند بزند.", "rating_cost": 10}],
        "rating": 1100.0,
    },
    {
