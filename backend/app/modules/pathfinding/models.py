"""Pathfinding speed-session model (60-second timed sessions).
...
class PathfindingSpeedSession(Base):
    __tablename__ = "pathfinding_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="pathfinding", index=True)
