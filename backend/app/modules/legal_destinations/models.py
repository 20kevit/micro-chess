"""Legal Destinations speed-session model (60-second timed sessions).
...
class LegalSpeedSession(Base):
    __tablename__ = "legal_speed_sessions"

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    exercise_slug: Mapped[str] = mapped_column(String(100), default="legal-destinations", index=True)
