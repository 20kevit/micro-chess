...
from app.modules.puzzles.models import SOURCE_GENERATED
        ...
        for index in range(count):
            ...
            puzzle = stage_validated_puzzle(
                db,
                {
                    ...
                    "prompt_fa": candidate.get("prompt_fa") or "",
                ...
                source_reference=f"generator:{definition.code}",
                actor_id=actor_id,
                generator_run_id=run.id,
                validation_metadata={"generator": definition.code, "errors": []},
                history_reason=f"generated by {definition.code} v{definition.version}",
            )
